...
\\begin{center}
  ...
  \\vskip 0.5in
  \\large{
    \\textbf{<<authorone>>}\\footnote{<<roleone>>; email: \\url{<<emailone>>}} 
    \\ifthenelse{\\equal{<<authortwo>>}{}}{}{\ \ \ \\textbf{ <<authortwo>> }\\footnote{<<roletwo>>; email: \\url{<<emailtwo>>}}}
    \\ifthenelse{\\equal{<<authorthree>>}{}}{}{\ \ \ \\textbf{ <<authorthree>> }\\footnote{<<rolethree>>; email: \\url{<<emailthree>>}}}
    \\ifthenelse{\\equal{<<authorfour>>}{}}{}{\ \ \ \\textbf{ <<authorfour>> }\\footnote{<<rolefour>>; email: \\url{<<emailfour>>}}}
  }
  \\vskip 0.4in
  <<department>> \\par
  \\vskip 0.4in
