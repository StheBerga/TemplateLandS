...
## Description
TemplateLandS is designed to streamline the creation of statistical reports. This package provides a ready-to-use template for generating customizable, easy-to-read reports. It is particularly suited for statistical analysis, including survival analysis for patient datasets, as well as univariate and multivariate statistical analyses.
...
After installing the package, you will need to restart R to access the template. To create a new R Markdown file utilizing TemplateLandS, navigate to File -> New File -> R Markdown. In the resulting window, choose "From Template," and then select "LandS LaTeX Report {TemplateLandS}" from the options on the right.
